...
#	--class com.bnsf.customreceiver.HdfsWordCount \ -- if using pass hdfs directory as argument /user/hdetldev/tstStream/
/usr/bin/spark-submit \
	...
	--master local[2] \
	--class com.bnsf.customreceiver.JsonTest \
	...
	--files ./src/main/resources/hbase-site.xml \
	--num-executors 2 \
	--driver-memory 512m \
	...
	--principal hdetldev@RAILS.RWY.BNSF.COM --keytab /etc/security/keytabs/hdetldev.headless.keytab      \
	build/libs/data-streaming-1.0.0.jar  $1
