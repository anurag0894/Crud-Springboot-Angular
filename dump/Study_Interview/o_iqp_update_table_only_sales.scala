...
object o_iqp_update_table_only_sales {
  val sConnect = new Utils.sparkConnection
  val spark = sConnect.connect("g00103.iqp_update_table")
  val tableName = "g00103.iqp_update_table_only_sales"
  var sqlString = ""
  var progressValue = ""
  ...
  def main(args: Array[String]): Unit = {
    ...
    try {
        ...
        sqlString = "select distinct table_name, batch_number, partition_column, temporary_partition, from_clause " +
                    ...
                    " where enabled_flag = 'Y' and table_name='g00103.iqp_sales_agg' order by table_name, batch_number"
