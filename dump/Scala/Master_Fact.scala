...
try{
	...
	resultWithPartit.createOrReplaceTempView("factTable") 



	val sql = s"""Insert overwrite table $schemaName.$des_tblName select * from factTable"""
	spark.sql(sql) 
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sourceMasterTableName = "iqp_fact_master"
